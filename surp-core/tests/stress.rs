//! Stress, concurrency, and soak tests for surp-core and surp-io.
//!
...
//! - Send/Sync safety
//!
//! Run with: cargo test -p surp-core --test stress -- --ignored
...
// that the owned Value and SurpValue types are fine:
#[test]
...
#[test]
#[ignore] // Run with: cargo test -p surp-core --test stress soak -- --ignored
