...
//!
//! # Surp Text Syntax (summary)
//!
//! The Surp textual notation is a unique, deterministic syntax that maps
...
impl<'a> Parser<'a> {
    ...
    fn error(&self, msg: impl Into<String>) -> SurpError {
...
///
/// ```
/// use surp_core::text::pretty_print;
/// use surp_core::Value;
///
