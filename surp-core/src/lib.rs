...
//! for the Surp binary format — a compact, canonical binary serializer
//! and human-readable alternative to JSON.
//!
//! ## Quick Start
//!
//! ```rust
//! use surp_core::{Value, Encoder, Decoder};
//!
...
pub use error::{Result, SurpError};
pub use limits::Limits;
pub use traits::Surp;
pub use traits::SurpBytes;
pub use value::{SurpValue, Value};
